...
import numpy as np
from sklearn import (metrics, cross_validation, preprocessing,grid_search)
...
def main():
    ...
    """
    model = GradientBoostingClassifier()  # the classifier we'll use
    #parameters = {'n_estimators':[10,20,30,40,50,60,70],
    #              'max_depth':[5,10,20,50,None],
    #              'min_samples_split':[2,5,10],
    #              'min_samples_leaf':[1,2,5],
    #              'min_density':[0.1,0.5,0.9]}
